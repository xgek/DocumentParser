// src/lib.rs
/*
 * Core library for DocumentParser
 */
...
#[derive(Debug)]
pub struct DocumentParserProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DocumentParserProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DocumentParser processing");
    
    let mut processor = DocumentParserProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DocumentParserProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DocumentParserProcessor::new(false);
